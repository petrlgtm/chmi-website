      ...
      <section className="section">
        <div className="container container--prose">
          ...
          <div className="animate-on-scroll" ref={contentRef}>
            <div className="detail-hero-image mb-section-sm">
              <img
          ...
          <div className="animate-on-scroll" ref={scheduleRef}>
            <div className="branch-info-card mb-section-sm">
              <div className="card-heading-row" style={{ marginBottom: "1.5rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
                  {filteredBranches.length === 0 ? (
                    ...
                    filteredBranches.map((b) => (
                      <div key={b.branchId} className="dark-list-item">
                        <div>
                          <Link
                        ...
                        <span className="time-badge">{b.times}</span>
                      </div>
                    ))
                  )}
                </div>
                    ...
                    <div key={city} style={{ marginBottom: "1.5rem" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                        {filteredCells?.filter((c) => c.city === city).map((cell, i) => (
                          <div key={i} className="cell-location-row">
                            <div>
                            ...
                            <span className="cell-time-badge">{cell.day} {cell.time}</span>
                            <a href={`tel:${cell.contact}`} className="cell-contact-link">
          ...
          {/* Scripture */}
          <div className="scripture-card-dark mb-section-sm">
            <p style={{
          ...
          <div className="prev-next-nav">
            {prev ? (
              <Link to={`/services/${prev.id}`} className="prev-next-link">
                <ArrowLeft size={16} /> {prev.title}
              </Link>
            ) : <div />}
            {next ? (
              <Link to={`/services/${next.id}`} className="prev-next-link">
